...
const MerchantPay: React.FC<MerchantPayProps> = ({
  merchant,
  onBack,
  onPaymentSuccess,
}) => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="top-0 z-10">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Pay Merchant</h1>
        </div>
      </div>
        ...
        {step === 'confirm' && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">Review your merchant payment details</p>
            </div>
          ...
          <div className="text-center space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Your merchant payment has been processed
              </p>
            </div>
